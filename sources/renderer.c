	...
	void renderer_create_framebuffers( )
	{
		...
		if ( defaults.effects_level == 1 )
		{
   		...
   		ogl_framebuffer_with_texture( 	&rnd.fb_game ,
        								&rnd.tex_game ,
        								&rnd.depth_game ,
        								fulld ,
        								fulld );

        ogl_framebuffer_with_texture( 	&rnd.fb_glow ,
        								&rnd.tex_glow ,
        								&rnd.depth_glow ,
        								glowd ,
        								glowd );

        ogl_framebuffer_with_texture( 	&rnd.fb_blur ,
        								&rnd.tex_blur ,
        								&rnd.depth_blur ,
        								blurd ,
        								blurd );
    ...
    void renderer_init( GLuint defFrameBuffer ,
    					...
    					char* resources )
    {
        ...
        mtbus_subscribe( "UI" , renderer_onmessage );
        ...
        rnd.shader_glow = ogl_shader_create( glow_vsh ,
                                             glow_fsh ,
                                             uniforms_game ,
                                             attributes_game ,
                                             rnd.gameuniforms );

        rnd.shader_blur = ogl_shader_create( blur_vsh ,
                                             blur_fsh ,
                                             uniforms_blur ,
                                             attributes_blur ,
                                             rnd.bluruniforms );

        rnd.shader_blend = ogl_shader_create( blend_vsh ,
                                              blend_fsh ,
                                              uniforms_blend ,
                                              attributes_blend ,
                                              rnd.blenduniforms );
    ...
    void renderer_update_buffer( 	GLfloat* vertexes ,
    								uint32_t count ,
    								m4_t projection ,
									int level )
    {
    ...
    void renderer_render_scene( int* levelmap ,
    							int* drawmap )
    {
        			...
        			index++ )
        {
			...
			glUniformMatrix4fv( rnd.gameuniforms[ 0 ] ,
								1 ,
								0 ,
								projection.array );
    ...
    void renderer_render( )
    {
        ...
        glClearColor( 	defaults.backcolor.x ,
    ...
    void renderer_uploadvoxels( void* data )
    {
		...
		renderer_update_buffer( rnd.dynamicbuffer->data ,
								rnd.dynamicbuffer->length ,
								rdata->projection ,
								rdata->level );
